        ...
        orderArr.sort().forEach((items, index) => {
            resArr.push(
                ...
                <div key={index}  style={{height: 314, padding: "20px 0"}}>
                    <div className="box" onClick={() => {history.push({pathname: `/dynaProInfo/${items[`id`]}`})}}>
                        <div>
                ...
                <div id={index} key={index} style={{padding: "20px", }} onClick={() => {history.push({pathname: `/dynaProInfo/${items[`id`]}`})}}>
