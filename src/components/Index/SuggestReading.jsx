...
const SuggestReading = () => {
    ...
    useEffect(() => {
        setTimeout(() => {
            setData([{
                img: "http://iph.href.lu/200x200?text=%E5%8D%A0%E4%BD%8D%E7%AC%A6&fg=999999&bg=bbbbbb",
    ...
    if(isPc){
        return(
            <div style={{maxWidth: CONFIG.indexPageMaxWidth, width: isPc ? "100%" : "", margin: "auto"}}>
                <div style={{height: isPc ? 200 : 150, display: "flex", flexDirection: "row", padding: "40px"}}>
                    <div style={{ maxWidth: 500, overflow: 'hidden'}}><img src="http://iph.href.lu/200x200?text=%E5%8D%A0%E4%BD%8D%E7%AC%A6&fg=999999&bg=bbbbbb" alt="" width="389px" ></img></div>
        ...
        return(
            ...
            <div style={{ display: "flex", flexDirection: "column"}}>
                <div style={{margin: "20px 40px 0 40px", maxWidth: "500px", overflow: 'hidden'}}><img src="http://iph.href.lu/200x200?text=%E5%8D%A0%E4%BD%8D%E7%AC%A6&fg=999999&bg=bbbbbb" alt="" width="100%" ></img></div>
