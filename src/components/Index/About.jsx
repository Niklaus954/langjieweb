        ...
        <div style={{background: "#3f51b5", color: "#ffffff"}}>
            <div className={classes.aboutWrap}>
                <div className={classes.about}>
                    ...
                    <div>服务QQ： <a style={{cursor: "pointer", color: "#fff"}} href="tencent://message/?uin=1820128000&Site=Sambow&Menu=yes"><img src={CONFIG.url(`/img/QQ.png`)} alt="" width="14px" height="14px"/><span style={{margin: 5}}>在线咨询</span></a> </div><br/>
